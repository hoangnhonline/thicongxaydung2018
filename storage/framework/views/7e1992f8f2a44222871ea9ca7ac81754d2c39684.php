        ...
        <div class="block-module block-news-sidebar">
          ...
          <div class="block-content">
            <ul class="list">
              ...
              <li class="item">
                <div class="thumb">
                  <a href="<?php echo e(route('news-detail', ['slug' => $articles->slug, 'id' => $articles->id])); ?>"><img src="<?php echo e($articles->image_url ? Helper::showImage($articles->image_url) : URL::asset('public/assets/images/no-img.png')); ?>" alt="<?php echo $articles->title; ?>"></a>
                </div>
