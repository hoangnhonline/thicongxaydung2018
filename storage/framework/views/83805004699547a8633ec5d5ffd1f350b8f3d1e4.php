    ...
    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
      <div class="panel-body">
        <ul>
          ...
          <li>
            <label>
            <input type="radio" name="menu_select" data-link="<?php echo e(route('news-list', $value->slug)); ?>" data-value="<?php echo e($value->id); ?>" data-type="5" data-title="<?php echo e($value->name); ?>" class="menu_select"> <?php echo e($value->name); ?>
