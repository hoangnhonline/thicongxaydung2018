            ...
            <div class="box-body">
              ...
              <?php endif; ?>
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="text" class="form-control" name="so_nam" id="so_nam" value="<?php echo e($settingArr['so_nam']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số kiến trúc sư và kỹ sư <span class="red-star">*</span></label>
                  <input type="text" class="form-control" name="so_kien_truc_su" id="so_kien_truc_su" value="<?php echo e($settingArr['so_kien_truc_su']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số công nhân</label>
                  <input type="text" class="form-control" name="so_cong_nhan" id="so_cong_nhan" value="<?php echo e($settingArr['so_cong_nhan']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số công trình <span class="red-star">*</span></label>
                  <input type="text" class="form-control" name="so_cong_trinh" id="so_cong_trinh" value="<?php echo e($settingArr['so_cong_trinh']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số bài viết 1 trang</label>
                  <input type="text" class="form-control" name="articles_per_page" id="articles_per_page" value="<?php echo e($settingArr['articles_per_page']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số sản phẩm 1 trang</label>
                  <input type="text" class="form-control" name="product_per_page" id="product_per_page" value="<?php echo e($settingArr['product_per_page']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Email nhận thông báo</label>
                  <input type="text" class="form-control" name="admin_email" id="admin_email" value="<?php echo e($settingArr['admin_email']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số sản phẩm liên quan </label>
                  <input type="text" class="form-control" name="product_related" id="product_related" value="<?php echo e($settingArr['product_related']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số tin liên quan </label>
                  <input type="text" class="form-control" name="article_related" id="article_related" value="<?php echo e($settingArr['article_related']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số sản phẩm widget </label>
                  <input type="text" class="form-control" name="product_widget" id="product_widget" value="<?php echo e($settingArr['product_widget']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số bài viết liên quan</label>
                  <input type="text" class="form-control" name="so_tin_lien_quan" id="so_tin_lien_quan" value="<?php echo e($settingArr['so_tin_lien_quan']); ?>">
                </div>
                <div class="form-group col-md-6">
                  <label>Số sản phẩm mỗi mục trang chủ</label>
                  <input type="text" class="form-control" name="hot_homepage" id="hot_homepage" value="<?php echo e($settingArr['hot_homepage']); ?>">
                </div>          
                ...
                <div class="form-group col-md-6">
                  ...
                  <textarea class="form-control" rows="3" name="chi_nhanh_phia_nam" id="chi_nhanh_phia_nam"><?php echo e($settingArr['chi_nhanh_phia_nam']); ?></textarea>
                </div>  
                <div class="form-group col-md-6">
                  <label>Chi nhánh phía Bắc</label>
                  <textarea class="form-control" rows="3" name="chi_nhanh_phia_bac" id="chi_nhanh_phia_bac"><?php echo e($settingArr['chi_nhanh_phia_bac']); ?></textarea>
                </div>                
                <div class="form-group col-md-6">
                  <label>Code google analystic </label>
                  <textarea name="google_analystic" id="google_analystic" rows="3" class="form-control"><?php echo e($settingArr['google_analystic']); ?></textarea>
                </div>   
                <div class="clearfix"></div>
                <div class="form-group col-md-6">
                  <label>Nội dung giới thiệu trang chủ </label>
                  <textarea name="gioi_thieu_chung" id="gioi_thieu_chung" rows="7" class="form-control"><?php echo e($settingArr['gioi_thieu_chung']); ?></textarea>
                </div>
                <div class="form-group col-md-6">
                  <label>Nội dung giới thiệu tin tức </label>
                  <textarea name="gioi_thieu_tin_tuc" id="gioi_thieu_tin_tuc" rows="7" class="form-control"><?php echo e($settingArr['gioi_thieu_tin_tuc']); ?></textarea>
                </div>                    
                <div class="clearfix"></div>
                ...
                <div class="form-group col-md-12" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-8 div-upload">
                    <img class="show_thumbnail icon_nam_hinh_thanh" src="<?php echo e($settingArr['icon_nam_hinh_thanh'] ? Helper::showImage($settingArr['icon_nam_hinh_thanh']) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-favicon" width="60">
                ...
                <div class="form-group col-md-12" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-8 div-upload">
                    <img class="show_thumbnail icon_kien_truc_su" src="<?php echo e($settingArr['icon_kien_truc_su'] ? Helper::showImage($settingArr['icon_kien_truc_su']) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-favicon" width="60">
                ...
                <div class="form-group col-md-12" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-8 div-upload">
                    <img class="show_thumbnail icon_cong_nhan" src="<?php echo e($settingArr['icon_cong_nhan'] ? Helper::showImage($settingArr['icon_cong_nhan']) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-favicon" width="60">
                ...
                <div class="form-group col-md-12" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-8 div-upload">
                    <img class="show_thumbnail icon_cong_trinh" src="<?php echo e($settingArr['icon_cong_trinh'] ? Helper::showImage($settingArr['icon_cong_trinh']) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-favicon" width="60">
                ...
                <div class="form-group col-md-12" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-8 div-upload">
                    <img class="show_thumbnail icon_tieu_de" src="<?php echo e($settingArr['icon_tieu_de'] ? Helper::showImage($settingArr['icon_tieu_de']) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-favicon" width="10">
                ...
                <div class="form-group col-md-12" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-8 div-upload">
                    <img class="show_thumbnail icon_mui_ten" src="<?php echo e($settingArr['icon_mui_ten'] ? Helper::showImage($settingArr['icon_mui_ten']) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-favicon" width="20">
            ...
            <div class="form-group col-md-12">
              ...
              <div class="form-group col-md-6">
                ...
                <div  class="input-group colorpicker-component mau">
                    <input type="text" value="<?php echo e($settingArr['mau_chu_dao']); ?>" class="form-control" name="mau_chu_dao" />
              ...
              <div class="form-group col-md-6">
                ...
                <div  class="input-group colorpicker-component mau">
                    <input type="text" value="<?php echo e($settingArr['hover_parent']); ?>" class="form-control" name="hover_parent" />
                    <span class="input-group-addon"><i></i></span>
                </div>
              </div>             
              <div class="form-group col-md-6">
                ...
                <div class="input-group colorpicker-component mau">
                    <input type="text" value="<?php echo e($settingArr['menu_border']); ?>" class="form-control" name="menu_border" />
                    <span class="input-group-addon"><i></i></span>
                </div>
              </div> 
              <div class="clearfix"></div>
...
<input type="hidden" name="icon_nam_hinh_thanh" id="icon_nam_hinh_thanh" value="<?php echo e($settingArr['icon_nam_hinh_thanh']); ?>"/>          
<input type="hidden" name="icon_kien_truc_su" id="icon_kien_truc_su" value="<?php echo e($settingArr['icon_kien_truc_su']); ?>"/>          
<input type="hidden" name="icon_cong_nhan" id="icon_cong_nhan" value="<?php echo e($settingArr['icon_cong_nhan']); ?>"/>
<input type="hidden" name="icon_cong_trinh" id="icon_cong_trinh" value="<?php echo e($settingArr['icon_cong_trinh']); ?>"/>          
<input type="hidden" name="icon_tieu_de" id="icon_tieu_de" value="<?php echo e($settingArr['icon_tieu_de']); ?>"/>
<input type="hidden" name="icon_mui_ten" id="icon_mui_ten" value="<?php echo e($settingArr['icon_mui_ten']); ?>"/>
