...
<div class="content-wrapper">
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('services.index')); ?>" style="margin-bottom:5px">Quay lại</a>
    ...
    <form role="form" method="POST" action="<?php echo e(route('services.update')); ?>">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('services.index')); ?>">Hủy</a>
            </div>
