...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="<?php echo e(route('member.store')); ?>">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              ...
              <?php endif; ?>                
                ...
                <div class="form-group" >                  
                  ...
                  <input type="text" class="form-control" name="chuc_vu" id="chuc_vu" value="<?php echo e(old('chuc_vu')); ?>">
                </div>             
                
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  <label class="col-md-3 row">Hình ảnh ( 164 x 164 px )</label>    
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="<?php echo e(old('image_url') ? Helper::showImage(old('image_url')) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-thumbnail" width="164" height="164">
