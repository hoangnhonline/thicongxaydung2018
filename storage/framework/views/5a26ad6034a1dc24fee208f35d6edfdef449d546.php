...
.block-breadcrumb .breadcrumb li.active, .block-breadcrumb .breadcrumb li.active a {
    color: <?php echo e($settingArr['mau_chu_dao']); ?>;
}
.block-search .block-search-inner {
    border: 1px solid <?php echo e($settingArr['mau_chu_dao']); ?>;
}
.block-search .form-category:after {
    color: <?php echo e($settingArr['mau_chu_dao']); ?>;
}
.btn-search {
    background: <?php echo e($settingArr['mau_chu_dao']); ?>;
}
.block-info i {
    color: <?php echo e($settingArr['mau_chu_dao']); ?>;
}
...
.ft-title .block-title:after {
    border-bottom: 2px solid <?php echo e($settingArr['mau_chu_dao']); ?>;
}
...
.block-members .active.center li.item img {
    border: 2px solid <?php echo e($settingArr['mau_chu_dao']); ?>;
}
...
.block-tabs .nav-tabs {
    border-bottom: 1px solid <?php echo e($settingArr['mau_chu_dao']); ?>;
}
.block-tabs .nav-tabs>li>a {
    background-color: <?php echo e($settingArr['mau_chu_dao']); ?>;
}
...
.block-tabs .tab-content {
    border-right: 1px solid <?php echo e($settingArr['mau_chu_dao']); ?>;
    border-bottom: 1px solid <?php echo e($settingArr['mau_chu_dao']); ?>;
    border-left: 1px solid <?php echo e($settingArr['mau_chu_dao']); ?>;
}
.block-tabs .title {
    color: <?php echo e($settingArr['mau_chu_dao']); ?>;
}
...
.ft-contact address p a {
    color: <?php echo e($settingArr['mau_chu_dao']); ?> !important;
}
.nav-menu>li:hover > a,
.nav-menu>li.active a {
    background: <?php echo e($settingArr['hover_parent']); ?>;
}
.nav-menu .submenu {    
    border-left: 1px solid <?php echo e($settingArr['hover_parent']); ?>;
}
...
.menu-top {
    border-bottom: 2px solid <?php echo e($settingArr['menu_border']); ?>;
}
.td-scroll-up{
    background: <?php echo e($settingArr['mau_chu_dao']); ?>;
}
.block-title-commom .block-title h2:before {
    ...
    content: url(<?php echo e($settingArr['icon_tieu_de']); ?>);
    
}
.block-title-commom .block-title h2:after {
    
    content: url(<?php echo e($settingArr['icon_mui_ten']); ?>);
