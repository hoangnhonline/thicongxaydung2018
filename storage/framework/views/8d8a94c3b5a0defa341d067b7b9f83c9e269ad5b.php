            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="home">                                   
                                    <div class="form-group col-md-4  pleft-5">
                                        ...
                                        <select class="form-control req" name="parent_id" id="parent_id">
                                            ...
                                            <?php echo e(old('parent_id') == $value->id ? "selected" : ""); ?>                           
                                    ...
                                    <div class="col-md-6 none-padding">
                                      <div class="checkbox">
                                          <label><input type="checkbox" name="is_slider" value="1" <?php echo e(old('is_slider', 1) == 1 ? "checked" : ""); ?>> Hiện slider </label>
                                      </div>                          
                                    </div>
                                    ...
                                    <div class="form-group col-md-12  pleft-5">
                                        ...
                                        <option value="1" <?php echo e(old('layout') == 1 ? "selected" : ""); ?>>Thông số chung</option>
                                        <option value="2" <?php echo e(old('layout') == 2 ? "selected" : ""); ?>>Thông số riêng</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group" style="margin-top:10px">
                                        ...
                                        <textarea class="form-control" rows="5" name="content" id="content"><?php echo e(old('content')); ?></textarea>
                                    </div>          
                                    <div class="clearfix"></div>                          
                                    <div class="clearfix"></div>
                                    <div class="form-group col-md-6 none-padding" style="margin-top:10px">
                                        <label>Tiến độ</label>
                                        <textarea class="form-control" rows="6" name="tien_do" id="tien_do"><?php echo e(old('tien_do')); ?></textarea>
                                    </div>
                                    <div class="form-group col-md-6" style="margin-top:10px">
                                        <label>Hỏi đáp</label>
                                        <textarea class="form-control" rows="6" name="hoi_dap" id="hoi_dap"><?php echo e(old('hoi_dap')); ?></textarea>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div role="tabpanel" class="tab-pane" id="lien-he">
                                    ...
                                    <div class="form-group col-md-12 " >                  
                                        ...
                                        <input type="text" class="form-control" name="thong_so_chi_tiet[<?php echo e($ts->id); ?>]" id="thong_so_chi_tiet<?php echo e($ts->id); ?>" value="<?php echo e(old('thong_so_chi_tiet[$ts->id]')); ?>">
                                    </div>
                                    <?php endforeach; ?>
                                    <div class="clearfix"></div>
                                </div>
                    ...
                    <div class="box-footer">             
                        ...
                        <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('product.index', ['parent_id' => $parent_id])); ?>">Hủy</a>
                    </div>
                </div>
                <!-- /.box -->     
            </div>
