            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <?php foreach( $items as $item ): ?>
                ...
                <tr id="row-<?php echo e($item->id); ?>">
                  ...
                  <td>                  
                    <a href="<?php echo e(route( 'account.edit', [ 'id' => $item->id ])); ?>"><?php echo e($item->display_name); ?></a>                                
                  </td>
                  ...
                  <td style="white-space:nowrap">  
                    ...
                    <?php if($item->articles->count() == 0 && $item->products->count() == 0): ?>
                    <a onclick="return callDelete('<?php echo e($item->full_name); ?>','<?php echo e(route( 'account.destroy', [ 'id' => $item->id ])); ?>');" class="btn-sm btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
                    <?php endif; ?>
