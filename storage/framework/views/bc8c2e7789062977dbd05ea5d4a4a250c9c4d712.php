          ...
          <table class="table table-bordered" id="table-list-data">
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <tr id="row-<?php echo e($item->id); ?>">
                ...
                <td style="text-align:center"><a class="btn btn-info btn-sm" href="<?php echo e(route('cate.index', ['parent_id' => $item->id])); ?>"><?php echo e($item->cates->count()); ?></a></td>
                ...
                <a class="btn btn-default btn-sm" href="<?php echo e(route('cate-parent', $item->slug )); ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i> Xem</a>                 
                  <a href="<?php echo e(route( 'cate-parent.edit', [ 'id' => $item->id ])); ?>" class="btn-sm btn btn-warning"><span class="glyphicon glyphicon-pencil"></span></a>                 
                  <?php if( $item->cates->count() == 0): ?>
                  <a onclick="return callDelete('<?php echo e($item->name); ?>','<?php echo e(route( 'cate-parent.destroy', [ 'id' => $item->id ])); ?>');" class="btn-sm btn btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
                  <?php endif; ?>
                </td>
              </tr> 
              <?php endforeach; ?>
