...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(route('member.index')); ?>">Ban lãnh đạo</a></li>
  ...
  <section class="content">
    <a class="btn btn-default btn-sm" href="<?php echo e(route('member.index')); ?>" style="margin-bottom:5px">Quay lại</a>
    <form role="form" method="POST" action="<?php echo e(route('member.update')); ?>">
    <div class="row">
      <!-- left column -->
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              <?php endif; ?>                
                ...
                <div class="form-group" >                  
                  ...
                  <input type="text" class="form-control" name="chuc_vu" id="chuc_vu" value="<?php echo e(old('chuc_vu', $detail->chuc_vu)); ?>">
                </div>             
               
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  <label class="col-md-3 row">Hình ảnh ( 164 x 164 px )</label>    
                  <div class="col-md-9">
                    <img id="thumbnail_image" src="<?php echo e($detail->image_url ? Helper::showImage($detail->image_url ) : URL::asset('public/admin/dist/img/img.png')); ?>" class="img-thumbnail" width="164" height="164">
            ...
            <div class="box-footer">
              ...
              <a class="btn btn-default btn-sm" class="btn btn-primary btn-sm" href="<?php echo e(route('member.index')); ?>">Hủy</a>
            </div>
